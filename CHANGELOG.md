...
* - Changing a password, by the user or by an administrator, left the account's other sessions logged in, so whoever knew the old password stayed in. A password change now ends all of the account's sessions.
